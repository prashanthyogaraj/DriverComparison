...
<form name="my_form" action = "result1" method = "post">
<table><tr><td>
...
<!--  	<option>clearAllTextFile</option> -->
...
<!-- <option value = 1>Check Individual Os Content</option> -->
	<option value ="0" selected = "selected">Check drivers by OS Name</option>
...
<tr>
<td><div id ="ostextbox" >Enter the OS'es<input type ="text" name = "newtext" id ="newtext" placeholder = "(e.g.Rhel6.7,sles12.1)"Size = "50" style= "border-style:groove" required></div></td></tr>
<tr>
